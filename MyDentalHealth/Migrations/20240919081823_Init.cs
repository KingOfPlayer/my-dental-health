	...
	public partial class Init : Migration
	{
		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.InsertData(
				...
				values: new object[,]
				{
					{ 1, 1, "My Description", "My Target Test", 1, new DateTime(2024, 9, 19, 11, 18, 22, 829, DateTimeKind.Local).AddTicks(6753), 1, 1, 1 },
					{ 2, 10, "My Description", "My Target Test2", 2, new DateTime(2024, 7, 31, 11, 18, 22, 829, DateTimeKind.Local).AddTicks(6772), 2, 1, 1 }
				});
			...
			migrationBuilder.InsertData(
				...
				values: new object[,]
				{
					{ 1, new DateTime(2024, 9, 18, 11, 18, 22, 829, DateTimeKind.Local).AddTicks(6885), "", 0, 10, 1 },
					{ 2, new DateTime(2024, 9, 4, 11, 18, 22, 829, DateTimeKind.Local).AddTicks(6888), "", 0, 10, 1 }
				});
