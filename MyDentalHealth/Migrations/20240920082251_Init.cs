    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "My Description", "My Target Test", 1, new DateTime(2024, 9, 13, 11, 22, 50, 774, DateTimeKind.Local).AddTicks(8155), 1, 1, 1 },
                    { 2, 10, "My Description", "My Target Test2", 2, new DateTime(2024, 8, 1, 11, 22, 50, 774, DateTimeKind.Local).AddTicks(8163), 2, 1, 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 19, 11, 22, 50, 774, DateTimeKind.Local).AddTicks(8277), "", 0, 10, 1 },
                    { 2, new DateTime(2024, 9, 5, 11, 22, 50, 774, DateTimeKind.Local).AddTicks(8279), "", 0, 10, 1 }
                });
