...
namespace Service
{
	public  class MailService : IMailService
	{
		...
		public async Task SendRevoceryMail(string toMail, string name, string link)
		{
			...
			{
				From = new MailAddress(fromEmail),
				Subject = "Reset Password - My Dental Health",Body = "<!DOCTYPE html><html><head><meta http-equiv=\"Content-Type\" content=\"text/html\"; charset=\"windows-1252\"></head><body style=\"width: 100%;background-color:#c3c3c3;font-family:system-ui, -apple-system, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, \"Noto Sans\", \"Liberation Sans\", sans-serif, \"Apple Color Emoji\", \"Segoe UI Emoji\", \"Segoe UI Symbol\", \"Noto Color Emoji\";\"><table style=\"width: 100%;background-color:#c3c3c3;\"><tbody><tr><td align=\"center\"><table style=\"width: 600px;\"><tbody><tr><td><div style=\"background-color:white;border:white;border-radius:5px;margin:5rem 1rem 5rem 1rem;padding:2rem;text-align: left;\"><div style=\"padding-left:1rem;\"><p class=\"boxheader\" style=\"font-size:2rem;\">Reset Password</p></div><hr><div style=\"font-size: 1rem;\"><p>Hi " +
				$"{name}" +
