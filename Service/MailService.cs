	...
	public  class MailService : IMailService
	{
		...
		public async Task SendNewUserMail(string toMail, string name)
		{
			var mailMessage = new MailMessage
			{
				...
				$"{name}" +
				",</p><ul><li><span>Login your account</span></li><li><span>Set your target</span></li><li><span>Every day track your target</span></li><li><span>Add status to your target when the time comes</span></li><li><span>Finaly get your health and secure your health</span></li></ul><p>There is login page</p><p>There is your password reset link</p><a href=\"localhost:5095/Account/Singin\" style=\"border:0.1rem;border-style:solid;border-color:blue;border-radius:0.5rem;background:blue;color:white;text-decoration:none;padding:0.8rem;display:inline-block;transition:0.2s;\">Login</a><p> Thank You for Join Us!</p></div></div></td></tr></tbody></table></td></tr></tbody></table></body></html>",
				IsBodyHtml = true,
			};
